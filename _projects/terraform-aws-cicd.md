...
* **Secure Authentication:** I configured OpenID Connect (OIDC) between GitHub Actions and AWS, removing the need for long-lived static credentials such as `AWS_ACCESS_KEY_ID`.
