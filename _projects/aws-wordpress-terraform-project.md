...
* **Automated Provisioning:** I wrote the `user_data` shell scripts to automatically install Apache, PHP, and WordPress upon instance boot, removing the need for manual SSH configuration.
